...
function nextIs(indList, direction){
    ...
    for(let i=0; i<indList.length;i++){
        if(direction == 1){ //left
           // console.log("left: "+colLeft[indList[i]])
           // console.log("new index: "+ colStart.indexOf(colLeft[indList[i]]))
            newIs.push(colStart.indexOf(colLeft[indList[i]]))
        }else{  //right
           // console.log("right: "+colRight[indList[i]])
            //console.log("new index: "+ colStart.indexOf(colRight[indList[i]]))
